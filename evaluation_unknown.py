...
train_dataset = CIFAR10(train=False, download=True, root='./datasets/', transform=transform)
# test_dataset = CIFAR100(train=False, download=True, root='./datasets/', transform=transform)
test_dataset1 = CIFAR100(train=False, download=True, root='./datasets/', transform=transform)
test_dataset2 = CIFAR100(train=True, download=True, root='./datasets/', transform=transform)
