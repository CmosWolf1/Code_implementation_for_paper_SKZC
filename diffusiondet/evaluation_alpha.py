...
for alpha in np.arange(0, 1, 0.01):
    ...
    print(f"alpha:{alpha} start to evaluate seen classes...")
    ...
    print(f"alpha:{alpha} start to evaluate unseen classes...")
...
# Create an array of x values from 0 to 1 with a step of 0.05
x_values = np.arange(0, 1, 0.01)

# Plotting the graph
plt.plot(x_values, H, marker='o')  # 'o' for circle markers on each point

# Providing labels and title
plt.xlabel('alpha')
plt.ylabel('H')
plt.title('Plot of H vs. alpha')
